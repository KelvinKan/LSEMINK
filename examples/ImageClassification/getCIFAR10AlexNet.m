function[Dtrain,Ctrain,Dval,Cval,Dtest,Ctest] = getCIFAR10AlexNet(nTrain, nTest, layer)
% This code is originated from the following paper and its Github repo:

% @article{fung2020admm,
...
% Github link: https://github.com/swufung/ADMMSoftmax

% The authors would like to thank Samy Wu Fung for sharing this code
